...
const ProjectModal = {
    ...
    projects: {
        ...
        3: {
            ...
            year: '2025',
            overview: 'An expressive streamgraph visualization that maps how emotions — curiosity, confusion, confidence, motivation, and frustration — shift and overlap across six stages of a creative process, from Research through Submission.',
            client: 'Self-Initiated',
            role: 'Designer & Researcher',
            timeline: 'Academic Project',
            challenge: 'The creative process is deeply emotional, yet it\'s rarely discussed in visual or quantitative terms. Designers often experience overlapping and contradictory feelings — excitement mixed with self-doubt, frustration giving way to breakthroughs — but there was no clear way to communicate this internal experience to others. The challenge was to find a visual form that could represent these fluid, overlapping emotional states without oversimplifying them.',
        ...
        4: {
            ...
            year: '2025',
            overview: 'An illustrated advertisement concept for Freecycle.org that reframes the act of giving away used creative tools as an investment in someone else\'s creative future — with the tagline "Give Creativity a Second Life."',
